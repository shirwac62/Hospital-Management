...
from wtforms import SelectField, IntegerField, SubmitField, DateField
...
class PrescribesForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.appointment_name.choices = [(0, "Select Appointment")] + [(a.appointment_name,a.appointment_name) for a in get_all(Appointment) ]
