...
from web.blueprints.nurse.forms import NursetForm
...
def pub_index():
    ...
    for n in data_list.items:
        row = [n.nurse_id, n.nurse_first_name, n.nurse_last_name, n.nurse_address, n.nurse_ph_no,
               '<a href="{0}"><i class="fa-solid fa-pen-to-square"></i></a>'.format(url_for('nurse.edit_nurse', nurse_id=n.nurse_id)) + " " + \
               '<a href="{0}"><i class="fa-solid fa-trash"></i></a>'.format(url_for('nurse.delete_nurse', nurse_id=n.nurse_id))]
